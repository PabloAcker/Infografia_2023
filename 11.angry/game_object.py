...
class Column(PassiveObject):
    def __init__(self, x, y, space):
        super().__init__("C:/Users/Pablo/Desktop/PabloAcker/.UPB/6_Sexto Semestre/Primer modulo/Infografia/programasPython/trabajosClase/11.angry/assets/img/column.png", x, y, space)


class Pig(arcade.Sprite):
    def __init__(self, x: float, y: float, space: pymunk.Space):
        super().__init__("C:/Users/Pablo/Desktop/PabloAcker/.UPB/6_Sexto Semestre/Primer modulo/Infografia/programasPython/trabajosClase/11.angry/assets/img/pig_failed.png", 0.1)
        mass = 2
